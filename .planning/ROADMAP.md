...
**Plans**: 4/9 plans executed across 4 waves (tracer-first: waves 1-2 are scaffolding, wave 3 leads with the
...
- [x] 01-04-PLAN.md — `StrategySpec` JSON-Schema contract, codegen pipeline, float-in-money guard (wave 2)
