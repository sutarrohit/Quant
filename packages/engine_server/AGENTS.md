# AGENTS.md — packages/engine_server

Guidance for any coding agent working in `packages/engine_server`. `CLAUDE.md` imports this file. The root
`AGENTS.md` (monorepo layout, working agreement) applies too.
